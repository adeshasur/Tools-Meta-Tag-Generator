...
function App() {
  return (
    <div className="min-h-screen overflow-hidden bg-[#f4f4f2] text-slate-950 selection:bg-[#d8d8d8] selection:text-slate-950 lg:h-screen">
      ...
      <header className="relative z-20 px-4 pt-3 md:px-6 md:pt-4">
      ...
      <main className="relative z-10 mx-auto flex max-w-7xl flex-col px-4 pb-6 pt-4 md:px-6 md:pb-8 md:pt-5 lg:h-[calc(100svh-84px)] lg:overflow-hidden">
